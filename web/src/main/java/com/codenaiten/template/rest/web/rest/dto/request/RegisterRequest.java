...
public record RegisterRequest(
        ...
        @Schema( description = "Nickname de usuario único", example = "username", requiredMode = Schema.RequiredMode.REQUIRED  )
        @NotNull
        ...
        @Schema( description = "Email de usuario", example = "email@domain.cc", requiredMode = Schema.RequiredMode.REQUIRED  )
        @NotNull
        ...
        @Schema( description = "Nombre del usuario", example = "Real Name", requiredMode = Schema.RequiredMode.REQUIRED  )
        @NotNull
        ...
        @Schema( description = "Apellido del usuario", example = "Optional Sruname", nullable = true )
        ...
        @Schema( description = "Fecha de nacimiento", example = "10/02/1993", requiredMode = Schema.RequiredMode.REQUIRED  )
        @NotNull
        @Pattern( regexp = "\\d{2}/\\d{2}/\\d{4}", message = "La fecha de nacimiento debe estar en formato (dd/mm/yyyy)." )
        LocalDate birthdate,

        @Schema( description = "Contraseña de usuario", example = "Password.123", requiredMode = Schema.RequiredMode.REQUIRED  )
        @NotNull
