    ...
    public SecurityFilterChain securityFilterChain( final HttpSecurity http, final CorsConfigurationSource corsConfigurationSource ) throws Exception {
        http.csrf( CsrfConfigurer::disable ) // Disable CSRF
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers( HttpMethod.GET, this.securityProperties.getIgnorePathsGet().toArray( new String[0] )).permitAll()
                        .requestMatchers( HttpMethod.POST, this.securityProperties.getIgnorePathsPost().toArray( new String[0] )).permitAll()
                        .requestMatchers( HttpMethod.PUT, this.securityProperties.getIgnorePathsPut().toArray( new String[0] )).permitAll()
                        .requestMatchers( HttpMethod.PATCH, this.securityProperties.getIgnorePathsPatch().toArray( new String[0] )).permitAll()
