package com.codenaiten.template.rest.app.old.vo.account;
...
// ------------------------------------------------------------------------------------------------------------------ \\
    ...
    /**
     * Constructor que crea un {@link AccountRole} a partir de un {@link String}.
     *
     * @param value {@link String} que representa el valor del {@link AccountRole}.
     */
    public AccountRole( final String value ){
        super( value );
