package com.codenaiten.template.rest.core.shared.spec;
...
//--------------------------------------------------------------------------------------------------------------------\\
    ...
    default Specification<T> and( final Specification<T> other ){
        return ( T candidate ) -> this.test( candidate ) && other.test( candidate );
    }
...
//--------------------------------------------------------------------------------------------------------------------\\
    ...
    default Specification<T> not(){
        return ( T candidate ) -> !this.test( candidate );
    }
