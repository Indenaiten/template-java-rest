...
// ------------------------------------------------------------------------------------------------------------------ \\
    ...
    protected void setOwner( final UserId owner ){
        if( Objects.isNull( owner ) ) throw new IllegalArgumentException( "Account Owner is required" );
        this.owner = owner;
    }

    public void setRole( final AccountRole role ){
        if( Objects.isNull( role )) throw new IllegalArgumentException( "Account Role is required" );
        this.role = role;
    }

    public void setEmail( final Email email ){
        if( Objects.isNull( email )) throw new IllegalArgumentException( "Account Email is required" );
        this.email = email;
    }

    public void setPassword( final EncodedPassword password ){
        if( Objects.isNull( password )) throw new IllegalArgumentException( "Account Encoded password is required" );
